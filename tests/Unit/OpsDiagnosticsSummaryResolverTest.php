...
it('normalizes doctor results into one ops diagnostics summary', function (): void {
    ...
    $manager = new class(collect([new DoctorResult('ops.ready', 'yezzmedia/laravel-ops', 'passed', 'Ready.', false), new DoctorResult('ops.health', 'yezzmedia/laravel-ops', 'warning', 'Needs review.', false), new DoctorResult('ops.cache', 'yezzmedia/laravel-ops', 'failed', 'Cache unavailable.', true, ['exception' => RuntimeException::class, 'message' => 'Cache ping failed.']), new DoctorResult('ops.skip', 'yezzmedia/laravel-ops', 'skipped', 'Skipped.', false)])) extends DoctorManager
    {
        /**
